...
docFromStrings ss cur =
  Doc
    { content = S.fromList (map bufferFromString ss)
    , cursor = cur
    , depth = length ss - 1
    }
  ...
  testGroup
    ...
    [ testCase "doc fits completely in viewport" $
        let d = docFromStrings ["line1", "line2", "line3"] (0, 0)
         ...
         in do
              assertEqual
                "render content should be the same"
                (fmap B.getString (content d))
                (fmap B.getString (rendercontent rd))
    ...
    , testCase "doc is larger than viewport, cursor inside" $
        let d = docFromStrings ["line1", "line2", "line3", "line4", "line5"] (2, 1)
            ...
            expectedContent =
              S.fromList
                [bufferFromString "line2", bufferFromString "line3", bufferFromString "line4"]
         in do
              assertEqual
                "render content should be sliced"
                (fmap B.getString expectedContent)
                (fmap B.getString (rendercontent rd))
    ...
    , testCase "cursor is above viewport" $
        let d = docFromStrings ["line1", "line2", "line3", "line4", "line5"] (0, 1)
            ...
            expectedContent =
              S.fromList
                [bufferFromString "line3", bufferFromString "line4", bufferFromString "line5"]
         in do
              assertEqual
                "render content should be sliced"
                (fmap B.getString expectedContent)
    ...
    , testCase "cursor is below viewport" $
        let d = docFromStrings ["line1", "line2", "line3", "line4", "line5"] (4, 1)
            ...
            expectedContent =
              S.fromList
                [bufferFromString "line1", bufferFromString "line2", bufferFromString "line3"]
         in do
              assertEqual
                "render content should be sliced"
                (fmap B.getString expectedContent)
